...
//	public static final Block FINAL_CASTLE_MINIATURE_STRUCTURE = Registry.register(Registry.BLOCK, TwilightForestMod.ID + ":final_castle_miniature_structure", new BlockTFMiniatureStructure());
	...
	public static final Block TIME_LOG_CORE = Registry.register(Registry.BLOCK, TwilightForestMod.ID + ":time_log_core", new SpecialMagicLogBlock(TIME_LOG_PROPS, MagicWoodVariant.TIME));
	public static final Block TRANSFORMATION_LOG_CORE = Registry.register(Registry.BLOCK, TwilightForestMod.ID + ":transformation_log_core", new SpecialMagicLogBlock(TRANSFORMATION_LOG_PROPS, MagicWoodVariant.TRANS));
	public static final Block MINING_LOG_CORE = Registry.register(Registry.BLOCK, TwilightForestMod.ID + ":mining_log_core", new SpecialMagicLogBlock(MINING_LOG_PROPS, MagicWoodVariant.MINE));
	public static final Block SORTING_LOG_CORE = Registry.register(Registry.BLOCK, TwilightForestMod.ID + ":sorting_log_core", new SpecialMagicLogBlock(SORTING_LOG_PROPS, MagicWoodVariant.SORT));
