...
public class TFEnchantments {
	...
	public static final EnchantmentCategory BLOCK_AND_CHAIN = EnchantmentCategory.ARMOR;// TODO: PORT .create("twilightforest_block_and_chain", item -> item instanceof ChainBlockItem);
}
