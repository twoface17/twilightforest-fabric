...
public class FierySwordItem extends SwordItem {
	...
	public static InteractionResult setFireBeforeDeath(Player player, Level world, InteractionHand hand, Entity entity, @org.jetbrains.annotations.Nullable EntityHitResult hitResult) {
		if(player.getMainHandItem().is(TFItems.FIERY_SWORD.get())) {
