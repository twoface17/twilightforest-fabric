...
//	});
	...
	private static Item spawnEgg(EntityType<? extends Mob> type, int color, int color2) {
		ResourceLocation eggId = new ResourceLocation(Objects.requireNonNull(type.getRegistryName()).getNamespace(), Registry.ENTITY_TYPE.getKey(type).getPath() + "_spawn_egg");
