...
//import twilightforest.client.UnbakedPatchModel;
//import twilightforest.lib.mixin.client.BlockModelAccessor;
//
//import static twilightforest.lib.client.model.HBMABFIB.getModelJson;
//
...
//    }
//
//    private static class Submodel implements ModelPart
//    {
...
//    }
//
//    public static class Geometry implements MultiPartModel<Geometry>
//    {
...
//
//        @Override
//        public Collection<? extends ModelPart> getParts()
//        {
//            return parts.values();
//        }
//
//        @Override
//        public Optional<? extends ModelPart> getPart(String name)
//        {
...
//    }
//
//    public static class Loader implements ModelResourceProvider
//    {
...
//                if(!modelContents.get("loader").getAsString().equals("forge:composite"))
//                    return null;
