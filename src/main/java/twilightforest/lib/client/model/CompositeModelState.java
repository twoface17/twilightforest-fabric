 ...
 */
public class CompositeModelState implements ModelState, IModelStateEx
{
    ...
    {
        return ((IModelStateEx)first).getPartTransformation(part).compose(((IModelStateEx)second).getPartTransformation(part));
    }
