...
public class TwilightSurfaceBuilders {
	...
	public static void register() {
		Registry.register(Registry.SURFACE_BUILDER, new ResourceLocation(TwilightForestMod.ID, "plateau"), DEADROCK_FILLING);
		Registry.register(Registry.SURFACE_BUILDER, new ResourceLocation(TwilightForestMod.ID, "glacier"), GLACIER);
		Registry.register(Registry.SURFACE_BUILDER, new ResourceLocation(TwilightForestMod.ID, "highlands"), HIGHLANDS);
	}
}
