...
public class ConfiguredWorldCarvers {
	...
	public static void register() {
		Registry.register(Registry.CARVER, new ResourceLocation(TwilightForestMod.ID, "tf_caves"), TFCAVES);
		Registry.register(Registry.CARVER, new ResourceLocation(TwilightForestMod.ID, "highland_caves"), HIGHLANDCAVES);
	}
