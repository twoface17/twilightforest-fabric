...
public final class ConfiguredFeatures {
    ...
    public static final ConfiguredFeature<?, ?> LAMPPOST = TwilightFeatures.registerWorldFeature(TwilightForestMod.prefix("lamppost"), TFBiomeFeatures.LAMPPOSTS.configured(new BlockStateConfiguration(BlockConstants.FIREFLY_JAR)).decorated(TwilightFeatures.OCCUPIES_SURFACE_CLEARANCE).decorated(Features.Decorators.HEIGHTMAP_WORLD_SURFACE).squared());
