...
public final class ConfiguredFeatures {
    ...
    public static final ConfiguredFeature<TFTreeFeatureConfig, ? extends Feature<?>> LARGE_WINTER_TREE_BASE = TwilightFeatures.registerWorldFeature(TwilightForestMod.prefix("tree/base/large_winter_tree_base"), TFBiomeFeatures.LARGE_WINTER_TREE.configured(TreeConfigurations.LARGE_WINTER));
    ...
    public static final ConfiguredFeature<?, ?> SIMPLE_WELL = TwilightFeatures.registerWorldFeature(TwilightForestMod.prefix("simple_well"), TFBiomeFeatures.SIMPLE_WELL.configured(FeatureConfiguration.NONE));
    public static final ConfiguredFeature<?, ?> FANCY_WELL = TwilightFeatures.registerWorldFeature(TwilightForestMod.prefix("fancy_well"), TFBiomeFeatures.FANCY_WELL.configured(FeatureConfiguration.NONE));
    ...
    public static final ConfiguredFeature<?, ?> DRUID_HUT = TwilightFeatures.registerWorldFeature(TwilightForestMod.prefix("druid_hut"), TFBiomeFeatures.DRUID_HUT.configured(FeatureConfiguration.NONE).decorated(TwilightFeatures.OCCUPIES_STRUCTURE_CLEARANCE).decorated(Features.Decorators.HEIGHTMAP_WORLD_SURFACE).rarity(105));
    public static final ConfiguredFeature<?, ?> GRAVEYARD = TwilightFeatures.registerWorldFeature(TwilightForestMod.prefix("graveyard"), TFBiomeFeatures.GRAVEYARD.configured(FeatureConfiguration.NONE).decorated(TwilightFeatures.OCCUPIES_SURFACE_CLEARANCE).rarity(75));

    //all the fun little things you find around the dimension
    public static final ConfiguredFeature<?, ?> BIG_MUSHGLOOM = TwilightFeatures.registerWorldFeature(TwilightForestMod.prefix("big_mushgloom"), TFBiomeFeatures.BIG_MUSHGLOOM.configured(FeatureConfiguration.NONE).decorated(TwilightFeatures.OCCUPIES_SURFACE_CLEARANCE).decorated(Features.Decorators.HEIGHTMAP_WORLD_SURFACE).squared());
    public static final ConfiguredFeature<?, ?> FALLEN_LEAVES = TwilightFeatures.registerWorldFeature(TwilightForestMod.prefix("fallen_leaves"), TFBiomeFeatures.FALLEN_LEAVES.configured(FeatureConfiguration.NONE).decorated(TwilightFeatures.OCCUPIES_SURFACE_CLEARANCE).decorated(Features.Decorators.HEIGHTMAP_WORLD_SURFACE).squared());
    ...
    public static final ConfiguredFeature<?, ?> FOUNDATION = TwilightFeatures.registerWorldFeature(TwilightForestMod.prefix("foundation"), TFBiomeFeatures.FOUNDATION.configured(FeatureConfiguration.NONE).decorated(TwilightFeatures.OCCUPIES_SURFACE_CLEARANCE).decorated(Features.Decorators.HEIGHTMAP_WORLD_SURFACE).rarity(100).squared());
    public static final ConfiguredFeature<?, ?> GROVE_RUINS = TwilightFeatures.registerWorldFeature(TwilightForestMod.prefix("grove_ruins"), TFBiomeFeatures.GROVE_RUINS.configured(FeatureConfiguration.NONE).decorated(TwilightFeatures.OCCUPIES_SURFACE_CLEARANCE).decorated(Features.Decorators.HEIGHTMAP_WORLD_SURFACE).rarity(105).squared());
    public static final ConfiguredFeature<?, ?> HOLLOW_LOG = TwilightFeatures.registerWorldFeature(TwilightForestMod.prefix("hollow_log"), TFBiomeFeatures.FALLEN_HOLLOW_LOG.configured(FeatureConfiguration.NONE).decorated(TwilightFeatures.OCCUPIES_SURFACE_CLEARANCE).decorated(Features.Decorators.HEIGHTMAP_WORLD_SURFACE).rarity(100).squared());
    public static final ConfiguredFeature<?, ?> HOLLOW_STUMP = TwilightFeatures.registerWorldFeature(TwilightForestMod.prefix("hollow_stump"), TFBiomeFeatures.HOLLOW_STUMP.configured(TreeConfigurations.HOLLOW_TREE).decorated(TwilightFeatures.OCCUPIES_SURFACE_CLEARANCE).decorated(Features.Decorators.HEIGHTMAP_WORLD_SURFACE).rarity(100).squared());
    public static final ConfiguredFeature<?, ?> HUGE_LILY_PAD = TwilightFeatures.registerWorldFeature(TwilightForestMod.prefix("huge_lily_pad"), TFBiomeFeatures.HUGE_LILY_PAD.configured(FeatureConfiguration.NONE).decorated(Features.Decorators.HEIGHTMAP_WORLD_SURFACE).rarity(20).squared().count(10));
    public static final ConfiguredFeature<?, ?> HUGE_WATER_LILY = TwilightFeatures.registerWorldFeature(TwilightForestMod.prefix("huge_water_lily"), TFBiomeFeatures.HUGE_WATER_LILY.configured(FeatureConfiguration.NONE).decorated(Features.Decorators.HEIGHTMAP_WORLD_SURFACE).rarity(50).squared().count(5));
    public static final ConfiguredFeature<?, ?> CICADA_LAMPPOST = TwilightFeatures.registerWorldFeature(TwilightForestMod.prefix("cicada_lamppost"), TFBiomeFeatures.LAMPPOSTS.configured(new BlockStateConfiguration(BlockConstants.CICADA_JAR)));
    public static final ConfiguredFeature<?, ?> FIREFLY_LAMPPOST = TwilightFeatures.registerWorldFeature(TwilightForestMod.prefix("firefly_lamppost"), TFBiomeFeatures.LAMPPOSTS.configured(new BlockStateConfiguration(BlockConstants.FIREFLY_JAR)));
    ...
    public static final ConfiguredFeature<?, ?> MONOLITH = TwilightFeatures.registerWorldFeature(TwilightForestMod.prefix("monolith"), TFBiomeFeatures.MONOLITH.configured(FeatureConfiguration.NONE).decorated(TwilightFeatures.OCCUPIES_SURFACE_CLEARANCE).decorated(Features.Decorators.HEIGHTMAP_WORLD_SURFACE).squared().rarity(90));
    ...
    public static final ConfiguredFeature<?, ?> PLANT_ROOTS = TwilightFeatures.registerWorldFeature(TwilightForestMod.prefix("plant_roots"), TFBiomeFeatures.UNDERGROUND_PLANTS.configured(new BlockStateConfiguration(BlockConstants.ROOT_STRAND)).decorated(TwilightFeatures.OCCUPIES_SURFACE_CLEARANCE).decorated(Features.Decorators.TOP_SOLID_HEIGHTMAP_SQUARE).range(Features.Decorators.RANGE_BOTTOM_TO_60).count(4));
    ...
    public static final ConfiguredFeature<?, ?> STONE_CIRCLE = TwilightFeatures.registerWorldFeature(TwilightForestMod.prefix("stone_circle"), TFBiomeFeatures.STONE_CIRCLE.configured(FeatureConfiguration.NONE).decorated(TwilightFeatures.OCCUPIES_SURFACE_CLEARANCE).decorated(Features.Decorators.HEIGHTMAP_WORLD_SURFACE).rarity(105).squared());
    public static final ConfiguredFeature<?, ?> THORNS = TwilightFeatures.registerWorldFeature(TwilightForestMod.prefix("thorns"), TFBiomeFeatures.THORNS.configured(new ThornsConfig(7, 3, 3, 50)).decorated(TwilightFeatures.CONFIGURED_THORNLANDS_BLANKETING));
    public static final ConfiguredFeature<?, ?> TORCH_BERRIES = TwilightFeatures.registerWorldFeature(TwilightForestMod.prefix("torch_berries"), TFBiomeFeatures.UNDERGROUND_PLANTS.configured(new BlockStateConfiguration(BlockConstants.TORCHBERRIES)).decorated(Features.Decorators.TOP_SOLID_HEIGHTMAP_SQUARE).range(Features.Decorators.RANGE_BOTTOM_TO_60).count(4).decorated(TwilightFeatures.OCCUPIES_UNDERGROUND_CLEARANCE));
    public static final ConfiguredFeature<?, ?> TROLL_ROOTS = TwilightFeatures.registerWorldFeature(TwilightForestMod.prefix("troll_roots"), TFBiomeFeatures.TROLL_VINES.configured(new BlockStateConfiguration(BlockConstants.TROLLVIDR)).decorated(Features.Decorators.TOP_SOLID_HEIGHTMAP_SQUARE).range(Features.Decorators.RANGE_BOTTOM_TO_60).count(4).countRandom(8));
    public static final ConfiguredFeature<?, ?> VANILLA_ROOTS = TwilightFeatures.registerWorldFeature(TwilightForestMod.prefix("vanilla_roots"), TFBiomeFeatures.UNDERGROUND_PLANTS.configured(new BlockStateConfiguration(BlockConstants.HANGING_ROOTS)).decorated(Features.Decorators.TOP_SOLID_HEIGHTMAP_SQUARE).range(Features.Decorators.RANGE_BOTTOM_TO_60).count(16).decorated(TwilightFeatures.OCCUPIES_UNDERGROUND_CLEARANCE));
    ...
    public static final ConfiguredFeature<?, ?> WOOD_ROOTS_SPREAD = TwilightFeatures.registerWorldFeature(TwilightForestMod.prefix("ore/wood_roots_spread"), TFBiomeFeatures.WOOD_ROOTS.configured(FeatureConfiguration.NONE).decorated(TwilightFeatures.OCCUPIES_SURFACE_CLEARANCE).range(Features.Decorators.RANGE_BOTTOM_TO_60).rarity(30).squared().count(20));
    ...
    //fallen logs!
    public static final ConfiguredFeature<?, ?> TF_OAK_FALLEN_LOG = TwilightFeatures.registerWorldFeature(TwilightForestMod.prefix("tf_oak_fallen_log"), TFBiomeFeatures.FALLEN_SMALL_LOG.configured(new HollowLogConfig(BlockConstants.TF_OAK_LOG, BlockConstants.HOLLOW_TF_OAK_LOG)).decorated(TwilightFeatures.OCCUPIES_SURFACE_CLEARANCE).decorated(Features.Decorators.HEIGHTMAP_OCEAN_FLOOR).rarity(40).squared());
    public static final ConfiguredFeature<?, ?> CANOPY_FALLEN_LOG = TwilightFeatures.registerWorldFeature(TwilightForestMod.prefix("canopy_fallen_log"), TFBiomeFeatures.FALLEN_SMALL_LOG.configured(new HollowLogConfig(BlockConstants.CANOPY_LOG, BlockConstants.HOLLOW_CANOPY_LOG)).decorated(TwilightFeatures.OCCUPIES_SURFACE_CLEARANCE).decorated(Features.Decorators.HEIGHTMAP_OCEAN_FLOOR).rarity(40).squared());
    public static final ConfiguredFeature<?, ?> MANGROVE_FALLEN_LOG = TwilightFeatures.registerWorldFeature(TwilightForestMod.prefix("mangrove_fallen_log"), TFBiomeFeatures.FALLEN_SMALL_LOG.configured(new HollowLogConfig(BlockConstants.MANGROVE_LOG, BlockConstants.HOLLOW_MANGROVE_LOG)).decorated(TwilightFeatures.OCCUPIES_SURFACE_CLEARANCE).decorated(Features.Decorators.HEIGHTMAP_OCEAN_FLOOR).rarity(40).squared());
    public static final ConfiguredFeature<?, ?> OAK_FALLEN_LOG = TwilightFeatures.registerWorldFeature(TwilightForestMod.prefix("oak_fallen_log"), TFBiomeFeatures.FALLEN_SMALL_LOG.configured(new HollowLogConfig(BlockConstants.OAK_LOG, BlockConstants.HOLLOW_OAK_LOG)).decorated(TwilightFeatures.OCCUPIES_SURFACE_CLEARANCE).decorated(Features.Decorators.HEIGHTMAP_OCEAN_FLOOR).rarity(40).squared());
    public static final ConfiguredFeature<?, ?> SPRUCE_FALLEN_LOG = TwilightFeatures.registerWorldFeature(TwilightForestMod.prefix("spruce_fallen_log"), TFBiomeFeatures.FALLEN_SMALL_LOG.configured(new HollowLogConfig(BlockConstants.SPRUCE_LOG, BlockConstants.HOLLOW_SPRUCE_LOG)).decorated(TwilightFeatures.OCCUPIES_SURFACE_CLEARANCE).decorated(Features.Decorators.HEIGHTMAP_OCEAN_FLOOR).rarity(40).squared());
    public static final ConfiguredFeature<?, ?> BIRCH_FALLEN_LOG = TwilightFeatures.registerWorldFeature(TwilightForestMod.prefix("birch_fallen_log"), TFBiomeFeatures.FALLEN_SMALL_LOG.configured(new HollowLogConfig(BlockConstants.BIRCH_LOG, BlockConstants.HOLLOW_BIRCH_LOG)).decorated(TwilightFeatures.OCCUPIES_SURFACE_CLEARANCE).decorated(Features.Decorators.HEIGHTMAP_OCEAN_FLOOR).rarity(40).squared());
    ...
    public static final ConfiguredFeature<?, ?> DARK_GRASS = TwilightFeatures.registerWorldFeature(TwilightForestMod.prefix("dark_grass"), TFBiomeFeatures.DARK_FOREST_PLACER.configured((new RandomPatchConfiguration.GrassConfigurationBuilder(new SimpleStateProvider(BlockConstants.GRASS), SimpleBlockPlacer.INSTANCE)).whitelist(ImmutableSet.of(BlockConstants.GRASS_BLOCK.getBlock())).tries(512).noProjection().build()).decorated(Features.Decorators.HEIGHTMAP_WORLD_SURFACE).count(4));
    public static final ConfiguredFeature<?, ?> DARK_FERNS = TwilightFeatures.registerWorldFeature(TwilightForestMod.prefix("dark_ferns"), TFBiomeFeatures.DARK_FOREST_PLACER.configured((new RandomPatchConfiguration.GrassConfigurationBuilder(new SimpleStateProvider(BlockConstants.FERN), SimpleBlockPlacer.INSTANCE)).whitelist(ImmutableSet.of(BlockConstants.GRASS_BLOCK.getBlock())).tries(256).noProjection().build()).decorated(Features.Decorators.HEIGHTMAP_WORLD_SURFACE).count(4));
