...
public class TFClientEvents {
	...
	public static void registerModels() {
		ModelLoadingRegistry.INSTANCE.registerModelProvider((resourceManager, consumer) -> consumer.accept(ShieldLayer.LOC));
		ModelLoadingRegistry.INSTANCE.registerModelProvider((resourceManager, consumer) -> new ModelResourceLocation(TwilightForestMod.prefix("trophy"), "inventory"));
		ModelLoadingRegistry.INSTANCE.registerModelProvider((resourceManager, consumer) -> new ModelResourceLocation(TwilightForestMod.prefix("trophy_minor"), "inventory"));
		ModelLoadingRegistry.INSTANCE.registerModelProvider((resourceManager, consumer) -> new ModelResourceLocation(TwilightForestMod.prefix("trophy_quest"), "inventory"));

		ModelLoadingRegistry.INSTANCE.registerModelProvider((resourceManager, consumer) -> TwilightForestMod.prefix("block/casket_obsidian"));
		ModelLoadingRegistry.INSTANCE.registerModelProvider((resourceManager, consumer) -> TwilightForestMod.prefix("block/casket_stone"));
		ModelLoadingRegistry.INSTANCE.registerModelProvider((resourceManager, consumer) -> TwilightForestMod.prefix("block/casket_basalt"));
	}
