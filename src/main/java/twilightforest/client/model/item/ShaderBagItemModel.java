...
//
////Use forwarding bakedmodel instead?
...
//			Minecraft.getInstance().getItemRenderer().render(item, ItemTransforms.TransformType.GUI, false, ms, bufferSource, 15728880, OverlayTexture.NO_OVERLAY, modelBack);
//
//			ms.popPose();
//
//			ms.pushPose();
...
//			ms.mulPose(Vector3f.XN.rotationDegrees(TFConfig.CLIENT_CONFIG.rotateTrophyHeadsGui ? Mth.sin(TFClientEvents.rotationTicker * 0.125F) : 30));
//			ms.mulPose(Vector3f.YN.rotationDegrees(TFConfig.CLIENT_CONFIG.rotateTrophyHeadsGui ? TFClientEvents.rotationTicker : 45));
//			ms.mulPose(Vector3f.ZN.rotationDegrees(TFConfig.CLIENT_CONFIG.rotateTrophyHeadsGui ? Mth.sin(TFClientEvents.rotationTicker * 0.125F) : 0));
